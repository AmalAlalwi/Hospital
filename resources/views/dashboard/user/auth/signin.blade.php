				...
				<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="{{URL::asset('dashboard/img/svgicons/banner-img.svg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
										...
										<div class="card-sigin">
											<div class="main-signup-header">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleFormControlSelect1">{{trans('dashboard/login_trans.Select_login_way')}}</label>
                                                    <select class="form-control" id="sectionChooser">
                                                        <option selected disabled>{{trans('dashboard/login_trans.Select_From_List')}}</option>
												...
												<h5 class="font-weight-semibold mb-4"> sign in to continue as patient</h5>
                                                <form method="POST" action="{{ route('login.user') }}">
                                                    @csrf

                                                    <div class="form-group">
														<label>Email</label> <input type="email" name="email" class="form-control" placeholder="Enter your email" required autofocus>
													</div>
													<div class="form-group">
                                                ...
                                                <div class="loginform" id="admin">
                                                    <h5 class="font-weight-semibold mb-4"> sign in to continue as admin</h5>
